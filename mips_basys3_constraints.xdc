...
set_property PACKAGE_PIN V16 [get_ports {i_switch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_switch}]
#set_property PACKAGE_PIN W16 [get_ports {i_switch}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {i_switch}]
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {o_data[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data[0]}]
set_property PACKAGE_PIN E19 [get_ports {o_data[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data[1]}]
set_property PACKAGE_PIN U19 [get_ports {o_data[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data[2]}]
set_property PACKAGE_PIN V19 [get_ports {o_data[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data[3]}]
set_property PACKAGE_PIN W18 [get_ports {o_data[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_data[4]}]
set_property PACKAGE_PIN U15 [get_ports {o_data[5]}]					
