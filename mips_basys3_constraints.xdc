...
# create_clock -add -name main_clock -period 10 -waveform {0 10} [get_ports i_clock]
...
set_property PACKAGE_PIN V16 [get_ports i_test]
...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports o_program_ended]
set_property IOSTANDARD LVCMOS33 [get_ports o_program_ended]
set_property PACKAGE_PIN W6 [get_ports o_test]
...
set_property PACKAGE_PIN V7 [get_ports o_program_loaded]
